...
public class PaladinSkills {
    ...
    private static Skills.Entry paladin_tier_3_spell_2_modifier_1() {
        var id = Identifier.fromNamespaceAndPath(NAMESPACE, "paladin_tier_3_spell_2_modifier_1");
    ...
    private static Skills.Entry paladin_tier_3_spell_2_modifier_2() {
        var id = Identifier.fromNamespaceAndPath(NAMESPACE, "paladin_tier_3_spell_2_modifier_2");
    ...
    private static Skills.Entry paladin_tier_2_spell_2_modifier_1() {
        var id = Identifier.fromNamespaceAndPath(NAMESPACE, "paladin_tier_2_spell_2_modifier_1");
    ...
    private static Skills.Entry paladin_tier_2_spell_2_modifier_2() {
        var id = Identifier.fromNamespaceAndPath(NAMESPACE, "paladin_tier_2_spell_2_modifier_2");
    ...
    private static Skills.Entry paladin_tier_4_spell_2_modifier_1() {
        var id = Identifier.fromNamespaceAndPath(NAMESPACE, "paladin_tier_4_spell_2_modifier_1");
        var title = "Condemn";
    ...
    private static Skills.Entry paladin_tier_4_spell_2_modifier_2() {
        var id = Identifier.fromNamespaceAndPath(NAMESPACE, "paladin_tier_4_spell_2_modifier_2");
