...
public class WeaponSkillModifiers {
    ...
    private static Skills.Entry weapon_arcane_root() {
        var id = new Identifier(NAMESPACE, "weapon_arcane_root");
    ...
    private static Skills.Entry weapon_arcane_blast_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_arcane_blast_modifier_1");
    ...
    private static Skills.Entry weapon_arcane_blast_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_arcane_blast_modifier_2");
    ...
    private static Skills.Entry weapon_fire_root() {
        var id = new Identifier(NAMESPACE, "weapon_fire_root");
    ...
    private static Skills.Entry weapon_fire_blast_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_fire_blast_modifier_1");
    ...
    private static Skills.Entry weapon_fire_blast_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_fire_blast_modifier_2");
    ...
    private static Skills.Entry weapon_frost_root() {
        var id = new Identifier(NAMESPACE, "weapon_frost_root");
    ...
    private static Skills.Entry weapon_frostbolt_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_frostbolt_modifier_1");
    ...
    private static Skills.Entry weapon_frostbolt_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_frostbolt_modifier_2");
    ...
    private static Skills.Entry weapon_holy_root() {
        var id = new Identifier(NAMESPACE, "weapon_holy_root");
    ...
    private static Skills.Entry weapon_holy_shock_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_holy_shock_modifier_1");
    ...
    private static Skills.Entry weapon_holy_shock_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_holy_shock_modifier_2");
    ...
    private static Skills.Entry weapon_sword_root() {
        var id = new Identifier(NAMESPACE, "weapon_sword_root");
        var spell = SpellBuilder.createSpellModifier();
    ...
    private static Skills.Entry weapon_swift_strikes_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_swift_strikes_modifier_1");
    ...
    private static Skills.Entry weapon_swift_strikes_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_swift_strikes_modifier_2");
        var title = "Precision";
    ...
    private static Skills.Entry weapon_flurry_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_flurry_modifier_1");
    ...
    private static Skills.Entry weapon_flurry_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_flurry_modifier_2");
    ...
    private static Skills.Entry weapon_mace_root() {
        var id = new Identifier(NAMESPACE, "weapon_mace_root");
        var spell = SpellBuilder.createSpellModifier();
        spell.school = ExternalSpellSchools.PHYSICAL_MELEE;
    ...
    private static Skills.Entry weapon_smash_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_smash_modifier_1");
    ...
    private static Skills.Entry weapon_smash_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_smash_modifier_2");
        var title = "Shatter";
    ...
    private static Skills.Entry weapon_hammer_root() {
        var id = new Identifier(NAMESPACE, "weapon_hammer_root");
        var spell = SpellBuilder.createSpellModifier();
        spell.school = ExternalSpellSchools.PHYSICAL_MELEE;
    ...
    private static Skills.Entry weapon_ground_slam_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_ground_slam_modifier_1");
    ...
    private static Skills.Entry weapon_ground_slam_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_ground_slam_modifier_2");
    ...
    private static Skills.Entry weapon_double_axe_root() {
        var id = new Identifier(NAMESPACE, "weapon_double_axe_root");
        var spell = SpellBuilder.createSpellModifier();
        spell.school = ExternalSpellSchools.PHYSICAL_MELEE;
    ...
    private static Skills.Entry weapon_whirlwind_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_whirlwind_modifier_1");
    ...
    private static Skills.Entry weapon_whirlwind_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_whirlwind_modifier_2");
        var title = "Hamstring";
    ...
    private static Skills.Entry weapon_spear_root() {
        var id = new Identifier(NAMESPACE, "weapon_spear_root");
        var spell = SpellBuilder.createSpellModifier();
        spell.school = ExternalSpellSchools.PHYSICAL_MELEE;
    ...
    private static Skills.Entry weapon_impale_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_impale_modifier_1");
        var title = "Pierce";
    ...
    private static Skills.Entry weapon_impale_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_impale_modifier_2");
        var title = "Pin Down";
    ...
    private static Skills.Entry weapon_dagger_root() {
        var id = new Identifier(NAMESPACE, "weapon_dagger_root");
        var spell = SpellBuilder.createSpellModifier();
        spell.school = ExternalSpellSchools.PHYSICAL_MELEE;
    ...
    private static Skills.Entry weapon_fan_of_knives_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_fan_of_knives_modifier_1");
        var title = "Ricochet";
    ...
    private static Skills.Entry weapon_fan_of_knives_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_fan_of_knives_modifier_2");
    ...
    private static Skills.Entry weapon_sickle_root() {
        var id = new Identifier(NAMESPACE, "weapon_sickle_root");
        var spell = SpellBuilder.createSpellModifier();
        spell.school = ExternalSpellSchools.PHYSICAL_MELEE;
    ...
    private static Skills.Entry weapon_swipe_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_swipe_modifier_1");
    ...
    private static Skills.Entry weapon_swipe_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_swipe_modifier_2");
...
//        );
    ...
    private static Skills.Entry weapon_glaive_root() {
        var id = new Identifier(NAMESPACE, "weapon_glaive_root");
        var spell = SpellBuilder.createSpellModifier();
        spell.school = ExternalSpellSchools.PHYSICAL_MELEE;
    ...
    private static Skills.Entry weapon_thrust_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_thrust_modifier_1");
    ...
    private static Skills.Entry weapon_thrust_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_thrust_modifier_2");
    ...
    private static Skills.Entry weapon_bow_root() {
        var id = new Identifier(NAMESPACE, "weapon_bow_root");
        var spell = SpellBuilder.createSpellModifier();
    ...
    private static Skills.Entry weapon_bow_passive_1() {
        var id = new Identifier(NAMESPACE, "weapon_bow_passive_1");
        ...
        var impact = SpellBuilder.Impacts.effectSet(RegistryIds.effect(StatusEffects.SLOWNESS), 3F, 1);
        spell.impacts = List.of(impact);
    ...
    private static Skills.Entry weapon_bow_passive_2() {
        var id = new Identifier(NAMESPACE, "weapon_bow_passive_2");
        ...
        var impact = SpellBuilder.Impacts.effectAdd(RegistryIds.effect(StatusEffects.POISON), 4F, 0, 1);
    ...
    private static Skills.Entry weapon_crossbow_root() {
        var id = new Identifier(NAMESPACE, "weapon_crossbow_root");
        var spell = SpellBuilder.createSpellModifier();
        spell.school = ExternalSpellSchools.PHYSICAL_RANGED;
    ...
    private static Skills.Entry weapon_crossbow_passive_1() {
        var id = new Identifier(NAMESPACE, "weapon_crossbow_passive_1");
        ...
        var impact = SpellBuilder.Impacts.effectSet(RegistryIds.effect(StatusEffects.WEAKNESS), 4F, 0);
        spell.impacts = List.of(impact);
    ...
    private static Skills.Entry weapon_crossbow_passive_2() {
        var id = new Identifier(NAMESPACE, "weapon_crossbow_passive_2");
        var title = "Fuse Bolt";
    ...
    private static Skills.Entry weapon_axe_root() {
        var id = new Identifier(NAMESPACE, "weapon_axe_root");
        var spell = SpellBuilder.createSpellModifier();
        spell.school = ExternalSpellSchools.PHYSICAL_MELEE;
    ...
    private static Skills.Entry weapon_cleave_modifier_1() {
        var id = new Identifier(NAMESPACE, "weapon_cleave_modifier_1");
    ...
    private static Skills.Entry weapon_cleave_modifier_2() {
        var id = new Identifier(NAMESPACE, "weapon_cleave_modifier_2");
